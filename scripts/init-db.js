...
async function createIndexes() {
  ...
  const indexes = [
    ...
    { 
      name: 'idx_oauth_clients_id', 
      sql: 'CREATE INDEX IF NOT EXISTS idx_oauth_clients_id ON oauth_clients(id)', 
      description: 'OAuth clients id index' 
    },
    { 
      name: 'idx_oauth_authorization_codes_code', 
      sql: 'CREATE INDEX IF NOT EXISTS idx_oauth_authorization_codes_code ON oauth_authorization_codes(code)', 
      description: 'Auth codes code index' 
    },
    { 
      name: 'idx_oauth_access_tokens_token', 
      sql: 'CREATE INDEX IF NOT EXISTS idx_oauth_access_tokens_token ON oauth_access_tokens(access_token)', 
      description: 'Access tokens index' 
    },
    { 
      name: 'idx_oauth_refresh_tokens_token', 
      sql: 'CREATE INDEX IF NOT EXISTS idx_oauth_refresh_tokens_token ON oauth_refresh_tokens(refresh_token)', 
      description: 'Refresh tokens index' 
    }
  ];
...
async function initDatabase() {
  try {
    ...
    console.log('\n💡 Next steps:');
    console.log('   • Set your API_KEY in the .env file');
    console.log('   • Start the server: npm run dev');
    console.log('   • Test the OAuth flow with your API key');
